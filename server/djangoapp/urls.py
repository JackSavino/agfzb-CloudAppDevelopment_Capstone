...
urlpatterns = [
    ...
    path(route='dealership-package/get_reviews', view=views.get_dealer_details, name='dealer_details'),

    # path for add a review view
    path(route='dealership-package/post_review', view=views.add_review, name='add_review'),
